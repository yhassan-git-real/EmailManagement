          ...
          <div className="max-w-6xl mx-auto">
            {!localIsConnected ? (
              ...
              <div className="animate-fadeIn transition-all duration-500">
                ...
                {/* Status summary with improved card styling */}
                <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 p-6">
                  <StatusSummary />
                </div>
              </div>
            )}
