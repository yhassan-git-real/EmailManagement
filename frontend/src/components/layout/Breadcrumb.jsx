        ...
        {items.map((item, index) => {
          ...
          return (
            <li key={index} className="flex items-center">
              {index > 0 && (
                <div className="mx-1.5 text-dark-300 flex items-center">
                  <svg
              ...
              {isLast || !item.path ? (
                <span
                  className={`flex items-center transition-all duration-300 ${isLast
                    ? 'bg-primary-500/15 text-primary-400 font-medium px-2.5 py-1 rounded-lg border border-primary-500/30 shadow-sm'
                    : 'text-text-muted'}`}
                >
                  {item.icon && (
                  ...
                  <span className="relative inline-block">
                    {item.label}
                    {isLast && (
                      <span className="absolute bottom-0 left-0 w-full h-0.5 bg-primary-500/50 rounded-full transform scale-x-0 origin-left transition-transform group-hover:scale-x-100"></span>
                    )}
                  </span>
                </span>
              ) : item.external ? (
                <a
                  ...
                  className="group flex items-center text-text-secondary hover:text-primary-400 px-2 py-0.5 rounded-lg hover:bg-primary-500/10 transition-all duration-200"
                >
                  {item.icon && (
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-3 w-3 ml-1 text-text-muted group-hover:text-primary-400 transition-colors duration-200"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
...
const HomeIcon = () => (
  <div className="rounded-md bg-primary-500/20 p-0.5">
