      ...
      <Header connectionInfo={connectionInfo} onDisconnect={onDisconnect} />
        ...
        <main className="flex-grow py-12 px-4 sm:px-8 lg:px-16 bg-gradient-to-b from-gray-50 to-gray-100 w-full md:ml-20">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-3xl font-bold mb-6 text-gray-800">Manual Email Compose</h1>
            
            <div className="bg-white rounded-xl shadow-lg p-6">
              <p className="text-gray-600">This is the Manual Email Compose page where you can create and send emails.</p>
              
              {/* Compose email form will go here */}
            </div>
          </div>
        </main>
      </div>
