-- Email Records Stored Procedures Setup Script
-- This script runs from the SQL Server Management Studio
...
FROM sys.tables
WHERE name = 'EmailRecords')
BEGIN
    PRINT 'Error: EmailRecords table does not exist';
    RETURN;
END

-- Print column information for debugging
PRINT 'EmailRecords Table Structure:';
SELECT
...
WHERE 
    c.object_id = OBJECT_ID('EmailRecords');
...
PRINT 'Creating sp_EmailRecords_CreateOrUpdate procedure...';
GO
...
PRINT 'sp_EmailRecords_CreateOrUpdate created successfully';
...
PRINT 'Creating sp_EmailRecords_Get procedure...';
GO
...
PRINT 'sp_EmailRecords_Get created successfully';
...
PRINT 'Creating sp_EmailRecords_Delete procedure...';
GO
...
PRINT 'sp_EmailRecords_Delete created successfully';
...
PRINT 'Creating sp_EmailRecords_UpdateStatus procedure...';
GO
...
PRINT 'sp_EmailRecords_UpdateStatus created successfully';
