      ...
      <div className="p-4">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center">
            <div className="w-8 h-8 rounded-lg bg-primary-500/20 text-primary-400 flex items-center justify-center mr-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-text-primary font-display">Email Status Report</h2>
              {lastUpdated && (
          ...
          <button
            ...
            disabled={loading}
            className="px-3 py-1.5 bg-primary-500/15 hover:bg-primary-500/25 text-primary-400 text-xs font-medium rounded-lg border border-primary-500/30 transition-all duration-300 group flex items-center hover:shadow-glow-sm"
          >
            <svg
      ...
      {loading && !statusData ? (
        <div className="pt-2 pb-4 flex justify-center">
          <div className="animate-pulse flex flex-col items-center w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mt-2 px-4">
              <div className="h-32 bg-dark-500 rounded-xl"></div>
              <div className="h-32 bg-dark-500 rounded-xl"></div>
              <div className="h-32 bg-dark-500 rounded-xl"></div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-2 px-4">
          <div className="transform transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-sm">
            <EmailStatusCard
              title="Sent"
          ...
          <div className="transform transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-sm">
            <EmailStatusCard
              ...
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-10 h-10 text-danger">
          ...
          <div className="transform transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-sm">
            <EmailStatusCard
              ...
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-10 h-10 text-warning">
